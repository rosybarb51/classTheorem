import java.util.Scanner; // 해당 클래스에서만 소용됨

public class WordGame2 {
//	private java.util.Scanner sc1; // 임폴트 안 하고 이렇게 사용할 수도 있다.
	private Scanner sc;
...
//	사용자가 입력한 사람 수만큼 플레이어를 생성
	private void createPlayers() {
		System.out.print("게임에 참가하는 인원을 입력하세요 > ");
//		사용자 입력을 통해 참가자 수를 정함
		int nPlayer = sc.nextInt();
//		players 는 참가자를 저장하기 위한 Player 클래스의 배열
...
//			사용자 이름 입력
			String name = sc.next();
//			입력 받은 이름을 생성자의 매개변수로 사용하여 객체 생성
...
//		조건문에 true 넣어서 무한 반복, 끝말잇기가 틀릴 때까지
		while (true) {
//			Player타입의 배열인 players[index] 요소의 멤버 메서드 getUserWord를 호출
